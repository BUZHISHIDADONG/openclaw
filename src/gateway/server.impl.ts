...
let cachedPluginRuntime: ReturnType<typeof createPluginRuntime> | null = null;

function getChannelRuntime() {
  cachedPluginRuntime ??= createPluginRuntime();
  return cachedPluginRuntime.channel;
}
...
export async function startGatewayServer(
  ...
  const channelManager = createChannelManager({
    ...
    resolvePluginRuntime: getPluginRuntime,
  });
