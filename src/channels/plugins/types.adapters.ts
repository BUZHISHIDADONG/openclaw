...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
  ...
  /**
   * Optional full plugin runtime for bundled/native channel plugins that keep
   * their own runtime stores and need the canonical Plugin SDK surface.
   *
   * External plugins should continue preferring `channelRuntime` unless they
   * explicitly depend on the broader native runtime contract.
   */
